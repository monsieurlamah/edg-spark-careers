  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-energy-bg text-primary-foreground shadow-xl shadow-primary/30 hover:shadow-2xl hover:shadow-primary/40 hover:-translate-y-1 text-base font-bold",
        "hero-outline": "glass border-2 border-primary-foreground/30 text-foreground hover:bg-primary/10 text-base font-bold",
        gold: "gradient-gold-bg text-secondary-foreground shadow-lg shadow-secondary/30 hover:shadow-xl font-bold",
