...
const allJobs = [
  ...
  { id: 4, title: "Analyste Financier", location: "Conakry", type: "CDD", department: "Finance", urgent: false, isNew: true, posted: "Il y a 1 jour", deadline: "25 Fév 2026", description: "Participez aux décisions financières stratégiques d'une entreprise nationale en pleine croissance." },
  { id: 5, title: "Responsable RH", location: "Conakry", type: "CDI", department: "Ressources Humaines", urgent: false, isNew: false, posted: "Il y a 7 jours", deadline: "18 Fév 2026", description: "Façonnez la politique RH et attirez les meilleurs talents pour EDG." },
  ...
  { id: 7, title: "Comptable Principal", location: "Conakry", type: "CDI", department: "Finance", urgent: false, isNew: false, posted: "Il y a 10 jours", deadline: "12 Fév 2026", description: "Tenez les comptes d'une entreprise stratégique et contribuez à la transparence financière." },
      ...
      <div className="pt-28 pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto">Trouvez le poste qui correspond à vos ambitions</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="max-w-2xl mx-auto mb-12">
            <div className="glass-card p-3 flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Rechercher par titre, département ou ville..." className="pl-10 h-12 rounded-xl border-0 bg-muted/50" />
              </div>
              <Button variant="default" size="lg" className="shrink-0"><Filter className="h-4 w-4 mr-2" />Filtrer</Button>
            </div>
          </motion.div>
